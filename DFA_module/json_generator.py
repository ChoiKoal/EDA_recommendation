    ...
    def generate_json(self):
        for key in self.picked_scenario.keys():
            ...
            if scenario["Chart_Type"] == "scatter":
                ...
                measure_01 = {}
                measure_02 = {}
                dimension_01["name"] = None
                dimension_01["aggFunc"] = None
                json_scenario["dimension"].append(dimension_01)
                measure_01["name"] = scenario['X']
                measure_01["aggFunc"] = None
                json_scenario["measure"].append(measure_01)
                measure_02["name"] = scenario['Y']
                measure_02["aggFunc"] = None
                json_scenario["measure"].append(measure_02)
            else:
                dimension_01 = {}
                dimension_02 = {}
